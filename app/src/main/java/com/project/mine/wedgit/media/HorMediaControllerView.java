package com.project.mine.wedgit.media;
...
public class HorMediaControllerView extends FrameLayout {
    ...
    private OnHorControllerListener mOnHorControllerListener;

    public HorMediaControllerView(Context context) {
        this(context, null, 0);
    }

    public HorMediaControllerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorMediaControllerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initListener() {
        img_btn_back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnHorControllerListener != null) {
                    mOnHorControllerListener.onHorClickBack();
                }
        ...
        player_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    if (mOnHorControllerListener != null) {
                        mOnHorControllerListener.onHorClickPause();
                    }
                } else {
                    if (mOnHorControllerListener != null) {
                        mOnHorControllerListener.onHorClickStart();
                    }
                }
            }
        });
    ...
    public void setOnHorControllerListener(OnHorControllerListener onHorControllerListener) {
        this.mOnHorControllerListener = onHorControllerListener;
    }

    public interface OnHorControllerListener {
