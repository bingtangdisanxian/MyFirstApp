...
public class AnimationUtils {
    ...
    private static void slideView(final View view, final float p1, final float p2, final float p3, final float p4,
                                 long durationMillis, long delayMillis,
                                 final boolean startVisible, final boolean endVisible) {
        //点击时,如果处在动画阶段则不允许再次运行动画
    ...
    public static void slideButtons(Context context, final FloatingDraftButton button) {
        ...
        int buttonBottom = ScreenUtils.getScreenHeight() - button.getBottom();
