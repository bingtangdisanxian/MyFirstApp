...
public class VerticalMediaControllerView extends FrameLayout {
    ...
    public VerticalMediaControllerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VerticalMediaControllerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setData(ListBean listBean) {
        theliveNum.setText(listBean.view);
        Glide.with(getContext())
                .load(listBean.avatar)
                .transform(new GlideCircleTransform(getContext()))
                .into(ic_head);
        nickName.setText(listBean.nick);
        titleName.setText(listBean.title);
        ivIsFocus.setSelected(listBean.follow > 0);
