...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(BaseApplication.getmContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(BaseApplication.getmContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        if (isJumpWhenMore)
            cancelToast();
        if (sToast == null) {
            sToast = Toast.makeText(BaseApplication.getmContext(), text, duration);
        } else {
            sToast.setText(text);
