package com.project.mine.bean.yunyue.book;

import com.project.mine.bean.yunyue.movie.ImagesBean;
import com.project.mine.bean.yunyue.movie.RatingBean;
...
public class BookBean implements Serializable {
    ...
    public List<String> translator;// 翻译
}
